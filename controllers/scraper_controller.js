...
//examples used from other repos, class example and tutorials.
// responsible for controlling the flow of the application execution. 
// When you make a request (means request a page) to MVC application, a 
// controller is responsible for returning the response to that request.
